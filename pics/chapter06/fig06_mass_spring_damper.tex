...
\node[my_darkgray, anchor=north] at (2.0, -1.0)
    {\footnotesize damper~$d$};

% -------- Mass block (Masse m) ------------------------------
\fill[my_lightblue]     (4, -1.2) rectangle (6, 1.2);
\draw[my_darkblue, line width=1pt] (4, -1.2) rectangle (6, 1.2);
\node[my_darkgray]              at (5,  0.0) {\footnotesize mass};
\node[my_darkgray] at (5,  -0.3) {\footnotesize$m$};
...
% Floor line
\draw[my_darkgray, line width=1.5pt] (-0.6, -1.54) -- (6.8, -1.54);
